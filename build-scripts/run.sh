...
lipo -info ./build-output/Release/Sample.xcframework/ios-x86_64-simulator/iOS.framework/iOS >> ./build-logs/lipo/Release/info.txt
lipo -info ./build-output/Release/Sample.xcframework/macos-x86_64/macOS.framework/macOS >> ./build-logs/lipo/Release/info.txt
lipo -info ./build-output/Release/Sample.xcframework/tvos-arm64/tvOS.framework/tvOS >> ./build-logs/lipo/Release/info.txt
lipo -info ./build-output/Release/Sample.xcframework/tvos-x86_64-simulator/tvOS.framework/tvOS >> ./build-logs/lipo/Release/info.txt
lipo -info ./build-output/Release/Sample.xcframework/watchos-armv7k_arm64_32/watchOS.framework/watchOS >> ./build-logs/lipo/Release/info.txt
lipo -info ./build-output/Release/Sample.xcframework/watchos-i386-simulator/watchOS.framework/watchOS >> ./build-logs/lipo/Release/info.txt
...
otool -arch x86_64 -l ./build-output/Release/Sample.xcframework/ios-x86_64-simulator/iOS.framework/iOS > ./build-logs/otool/Release/ios-x86_64-simulator-load-commands.txt
otool -arch x86_64 -l ./build-output/Release/Sample.xcframework/macos-x86_64/macOS.framework/macOS > ./build-logs/otool/Release/macos-x86_64-load-commands.txt
...
otool -arch x86_64 -l ./build-output/Release/Sample.xcframework/tvos-x86_64-simulator/tvOS.framework/tvOS > ./build-logs/otool/Release/tvos-x86_64-simulator-load-commands.txt
otool -arch armv7k -l ./build-output/Release/Sample.xcframework/watchos-armv7k_arm64_32/watchOS.framework/watchOS > ./build-logs/otool/Release/watchos-armv7k-load-commands.txt
otool -arch arm64_32 -l ./build-output/Release/Sample.xcframework/watchos-armv7k_arm64_32/watchOS.framework/watchOS > ./build-logs/otool/Release/watchos-arm64_32-load-commands.txt
otool -arch i386 -l ./build-output/Release/Sample.xcframework/watchos-i386-simulator/watchOS.framework/watchOS > ./build-logs/otool/Release/watchos-i386-simulator-load-commands.txt
